...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "primary-gradient text-primary-foreground shadow-primary hover:shadow-secondary hover-glow",
        secondary: "secondary-gradient text-secondary-foreground shadow-secondary hover:shadow-primary hover-glow",
        outline: "border-2 border-primary bg-transparent text-primary hover:primary-gradient hover:text-primary-foreground hover:shadow-primary",
        hero: "hero-gradient text-white shadow-glow hover:scale-105 transform transition-bounce font-semibold",
        ...
        cart: "bg-success text-success-foreground hover:bg-success/90 shadow-card hover-lift",
      },
      size: {
